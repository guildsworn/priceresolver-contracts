...
interface IPriceResolverOracleContract {
  ...
  function init ( address defaultAdminAddress_, address moderatorAddress_, address tokenAddress_, address stableAddress_ ) external;
  ...
  function setPrice ( uint256 tokenPrice_, uint256 stablePrice_ ) external;
  function setStablePrice ( uint256 stablePrice_ ) external;
